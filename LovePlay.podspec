...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModuleLovePlay/LovePlay"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/LovePla.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LovePlay/LovePlay/**/*.{h,m}"
